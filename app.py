...
# -------------------------------
# 🧊 SIDEBAR (DATASET + SAMPLE QUERIES)
# -------------------------------
...
st.markdown(
    ...
    <div class="app-header">
        <div class="app-header-title">📊 Ecommerce Analytics AI Agent</div>
        <div class="app-header-subtitle">
            Ask natural-language questions about your ecommerce sales data – the AI will analyze it instantly.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
...
# -------------------------------
# 🔍 TOP INFO CARD (ONLY DATASET READY)
# -------------------------------
...
st.markdown(
    ...
    <div class="info-card">
        <div class="info-card-title">Dataset Loaded Successfully ✅</div>
        <div class="info-card-body">
            Your ecommerce dataset is connected and ready for analysis.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
...
if (ask_clicked or user_input) and user_input.strip():
    st.success("✅ Question received. Backend processing remains unchanged.")
